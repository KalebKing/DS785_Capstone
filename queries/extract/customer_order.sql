SELECT
    ...
    , V_BelegPos.stornierte_Menge AS "V_BelegPos.stornierte_Menge"
    , V_BelegPos.gelieferte_Menge AS "V_BelegPos.gelieferte_Menge"
    ...
    , V_BelegPos.Versandtermin AS "V_BelegPos.Versandtermin"
    , V_BelegPos.Wunschtermin AS "V_BelegPos.Wunschtermin"
    ...
    , V_BelegPos.AnlageBenutzer AS "V_BelegPos.AnlageBenutzer"
    ...
    , BU_Benutzer.Name AS "BU_Benutzer.Name"
...
FROM
    ...
    LEFT JOIN PUB.BU_Benutzer
        ON V_BelegPos.AnlageBenutzer = BU_Benutzer.Benutzer