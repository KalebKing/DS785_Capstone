create table if not exists production.star."Ship To History" (
-- create or replace table production.star."Ship To History" (
    ...
    "City" varchar(250) comment 'City where the ship to''s located',
    "Country (English)" varchar(100) comment 'Country where the ship to''s located',
    "Country (German)" varchar(100) comment 'Country where the ship to''s located',
    ...
    "Current Record" boolean comment 'Indicates if the record is the most recent and active entry for the ship to',
    "Customer Number" number(38, 0) comment 'Unique identifier for customer associated with the ship to record',
    "Effective Date" timestamp_ntz(9) comment 'Date when this version of ship to record took effect',
    "Expiration Date" timestamp_ntz(9) comment 'Date when this version of ship to record was replaced with a newer version',
    ...
    "Key" number(38, 0) comment 'Unique identifier for this version of ship to',
    ...
    "Postal Code" varchar(25) comment 'Postal or ZIP code where the ship to''s located',
    ...
    "State/Province" varchar(100) comment 'State or province where the ship to''s located',
    ...
    constraint "ShipToHistoryPK" primary key ("Key")
)
    comment = 'History of changes to ship to records';