create table if not exists production.star."Customer History" (
-- create or replace table production.star."Customer History" (
    ...
    , "Current Record" boolean comment 'Indicates if the record is the most recent and active entry for the customer'
    ...
    , "Expiration Date" timestamp_ntz(9) comment 'Date when this version of customer record was replaced with a newer version'
    ...
    , constraint "CustomerHistoryPK" primary key ("Key")
)
    comment = 'History of changes to records in the customer dimension'
;